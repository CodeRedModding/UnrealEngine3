/*=============================================================================
	NxTornadoForceFieldCapsule.cpp
...
IMPLEMENT_CLASS(ANxTornadoAngularForceFieldCapsule);

void ANxTornadoAngularForceFieldCapsule::InitRBPhys()
{
	Super::InitRBPhys();
}

void ANxTornadoAngularForceFieldCapsule::TermRBPhys(FRBPhysScene* Scene) 
{
	Super::TermRBPhys(Scene);
}


void ANxTornadoAngularForceFieldCapsule::TickSpecial(FLOAT DeltaSeconds)
{
...
#if WITH_EDITOR
void ANxTornadoAngularForceFieldCapsule::EditorApplyScale(const FVector& DeltaScale, const FMatrix& ScaleMatrix, const FVector* PivotLocation, UBOOL bAltDown, UBOOL bShiftDown, UBOOL bCtrlDown)
{
...
void ANxTornadoAngularForceFieldCapsule::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
	if(RenderComponent)
	{
		{
...
FPointer ANxTornadoAngularForceFieldCapsule::DefineForceFieldShapeDesc()
{
#if WITH_NOVODEX
	// Capsule
