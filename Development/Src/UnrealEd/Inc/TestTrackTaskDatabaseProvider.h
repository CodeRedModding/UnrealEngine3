/*=============================================================================
	TestTrackTaskDatabaseProvider.h: Integrates TestTrack Pro task database
...
#ifndef __TestTrackTaskDatabaseProvider_h__
#define __TestTrackTaskDatabaseProvider_h__
...
public:
	 ...
	 */
	virtual UBOOL QueryAvailableDatabases( const FString& InServerURL, const FString& InUserName, const FString& InPassword, TArray< FString >& OutDatabaseNames );
	 ...
	 * @return	True if successful
	 */
	virtual UBOOL ConnectToDatabase( const FString& InServerURL, const FString& InUserName, const FString& InPassword, const FString& InDatabaseName, FString& OutUserRealName, TArray< FString >& OutResolutionValues, FString& OutOpenTaskStatusPrefix );
	 ...
	 * @return	True if successful
	 */
	virtual UBOOL DisconnectFromDatabase();
	 ...
	 */
	virtual UBOOL QueryFilters( TArray< FString >& OutFilterNames );
	 ...
	 * @return	Returns true if successful
	 */
	virtual UBOOL QueryTasks( const FString& InFilterName, TArray< FTaskDatabaseEntry >& OutTaskList );
	 ...
	 * @return	Returns true if successful
	 */
	virtual UBOOL QueryTaskDetails( const UINT InNumber, FTaskDatabaseEntryDetails& OutDetails );
	 ...
	 * @return	Returns true if successful
	 */
	virtual UBOOL MarkTaskComplete( const UINT InNumber, const FTaskResolutionData& InResolutionData );
	 ...
	 */
	virtual const UBOOL LastErrorWasCausedByDisconnection() const
	{
...
protected:
	 ...
	 */
	UBOOL VerifyTTPSucceeded( const INT ResultCode );
...
protected:
	...
	UBOOL bLastErrorWasCausedByDisconnection;
...
#endif // __TestTrackTaskDatabaseProvider_h__
