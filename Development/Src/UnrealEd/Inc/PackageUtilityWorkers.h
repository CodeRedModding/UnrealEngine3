...
enum EPackageInfoFlags
{
	...
	PKGINFO_Paths		=0x40,
	PKGINFO_Thumbs		=0x80,
	PKGINFO_CrossLevel	=0x100,

	PKGINFO_All			= PKGINFO_Names|PKGINFO_Imports|PKGINFO_Exports|PKGINFO_Chunks|PKGINFO_Depends|PKGINFO_Paths|PKGINFO_Thumbs|PKGINFO_CrossLevel,
};
