...
WxWizard_NewTerrain::WxWizard_NewTerrain( wxWindow* InParent, int InID )
	: wxWizard( InParent, InID, *LocalizeUnrealEd("NewTerrainWizard"), GApp->EditorFrame->GetWizardB() )
{
...
UBOOL WxWizard_NewTerrain::RunTerrainWizard()
{
