/*=============================================================================
	UnAsyncLoadingAndroid.h: Definitions of classes used for content streaming on Android.
	Copyright 1998-2013 Epic Games, Inc. All Rights Reserved.
=============================================================================*/

#ifndef __UNASYNCLOADINGANDROID_H__
#define __UNASYNCLOADINGANDROID_H__

#include "AndroidThreading.h"

/**
 * Android implementation of an async IO manager.	
 */
struct FAsyncIOSystemAndroid : public FAsyncIOSystemBase
{
	/**
	 * Constructor
	 */
	FAsyncIOSystemAndroid()
	{
	}
	 ...
	 */
	virtual UBOOL PlatformRead(FAsyncIOHandle FileHandle, INT Offset, INT Size, void* Dest);
