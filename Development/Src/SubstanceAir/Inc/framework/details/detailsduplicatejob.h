...
//! @brief Substance Air Framework Render Job duplication context structure def.
...
protected:
	...
	typedef std::map<guid_t,DeltaState, guid_t_comp> DeltaStates;
