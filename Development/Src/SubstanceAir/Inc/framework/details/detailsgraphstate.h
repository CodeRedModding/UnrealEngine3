...
//! @brief Substance Air Framework Graph Instance State definition
...
class GraphState : Uncopyable
{
public:
	//! @brief Pointer on LinkData type
	typedef std::tr1::shared_ptr<LinkData> LinkDataPtr;
