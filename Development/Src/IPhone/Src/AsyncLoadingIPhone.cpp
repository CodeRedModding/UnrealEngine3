/*=============================================================================
 	UnAsyncLoadingIPhone.cpp: Unreal async loading code, IPhone implementation.
...
/*-----------------------------------------------------------------------------
 FAsyncIOSystemIPhone implementation.
 -----------------------------------------------------------------------------*/
 ...
 */
UBOOL FAsyncIOSystemIPhone::PlatformReadDoNotCallDirectly( FAsyncIOHandle FileHandle, INT Offset, INT Size, void* Dest )
{
	ssize_t BytesRead = 0;
 ...
 */
FAsyncIOHandle FAsyncIOSystemIPhone::PlatformCreateHandle( const TCHAR* Filename )
{
 ...
 */
void FAsyncIOSystemIPhone::PlatformDestroyHandle( FAsyncIOHandle FileHandle )
{
 ...
 */
UBOOL FAsyncIOSystemIPhone::PlatformIsHandleValid( FAsyncIOHandle FileHandle )
{
	const int Handle = (int) ((PTRINT) FileHandle.Handle);
	return Handle != -1;
}
