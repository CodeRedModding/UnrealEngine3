/*=============================================================================
	FullscreenMovieIPhone.h: Fullscreen movie playback for iOS
	Copyright 1998-2013 Epic Games, Inc. All Rights Reserved.
=============================================================================*/

#ifndef _FULLSCREENMOVIEIPHONE_H_
#define _FULLSCREENMOVIEIPHONE_H_

/**
* Fallback movie implementation. Simply clears the screen
*/
class FFullScreenMovieIPhone : public FFullScreenMovieSupport
{
public:
	...
	*/
	...
	/** 
	* Adds a text overlay to the movie, clearing ALL existing overlays before doing so
	*
	* @param Font Font to use to display (must be in the root set so this will work during loads)
	* @param Text Text to display
	* @param X X location in resolution-independent coordinates (ignored if centered)
	...
	* @param WrapWidth Number of pixels before text should wrap
	*/
	void GameThreadAddSingleOverlay(UFont* Font, const FString& Text, FLOAT X, FLOAT Y, FLOAT ScaleX, FLOAT ScaleY, UBOOL bIsCentered, UBOOL bIsWrapped, FLOAT WrapWidth );
...
protected:
	...
	* Constructor
	*/
	FFullScreenMovieIPhone(UBOOL bUseSound=TRUE); 

	/** Startup movie sequence */
	TArray<FString> StartupMovieNames;

	/** Set of movies that are skippable by button presses */
	TSet<FString> SkippableMovieNames;
	...
	*/
	void* FillOverlayParams(UFont* Font, const FString& Text, FLOAT X, FLOAT Y, FLOAT ScaleX, FLOAT ScaleY, UBOOL bIsCentered, UBOOL bIsWrapped, FLOAT WrapWidth );
	

};

#endif //_FULLSCREENMOVIEIPHONE_H_
