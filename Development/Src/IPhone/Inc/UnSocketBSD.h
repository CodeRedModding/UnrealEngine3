...
protected:
	...
	/** Cache the settings (-1 means it has never been set) */
	ESocketType SavedType;
	INT SavedNonBlocking;
	INT SavedBroadcast;
	INT SavedReuseAddr;
	INT SavedLinger;
	INT SavedLingerTimeout;
	INT SavedRecvError;
	INT SavedSendBufferSize;
	INT SavedReceiveBufferSize;
	FInternetIpAddr SavedAddr;
