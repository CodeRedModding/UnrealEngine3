/**
 * IPhoneThreading.h -- Contains all iPhone platform-specific definitions
...
#ifndef _IPHONE_THREADING_H
#define _IPHONE_THREADING_H
...
////////////////////
// @todo iphone: If we merge the unix code in to main branch, we could pretty easily share this
...
{
	// @todo iphone: we got this code from Unix code, but looking at what it returns, it seems like a structure
...
{
	// not needed on single proc iPhone
	return (DWORD)-1;
}
...
/**
 * This is the IPhone version of a critical section.
 */
...
/**
 * This is the IPhone version of an event
 */
class FEventIPhone : public FEvent
{
...
/**
 * This is the IPhone factory for creating various synchronization objects.
 */
class FSynchronizeFactoryIPhone : public FSynchronizeFactory
{
public:
	/**
	 * Zeroes its members
	 */
	FSynchronizeFactoryIPhone(void);
...
/**
 * This is the IPhone class used for all poolable threads
 */
class FQueuedThreadIPhone : public FQueuedThread
{
	/**
 ...
 * platform specific code, while this class provides all of the IPhone
 * specific methods. It handles the creation of the threads used in the
 * thread pool.
 */
class FQueuedThreadPoolIPhone : public FQueuedThreadPoolBase
{
public:
	/**
	 * Cleans up any threads that were allocated in the pool
	 */
	virtual ~FQueuedThreadPoolIPhone(void);
 ...
 */
class FRunnableThreadIPhone : public FRunnableThread
{
	/**
	 * The thread handle to clean up. Must be closed or this will leak resources
	 */
...
/**
 * This is the factory interface for creating threads on IPhone
 */
class FThreadFactoryIPhone : public FThreadFactory
{
public:
	/**
	 * Creates the thread with the specified stack size and thread priority.
...
#endif  // define _IPHONE_THREADING_H
