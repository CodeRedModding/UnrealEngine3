...
class FMacSupport : public FConsoleSupport
{
public:
	FMacSupport(void* Module);
	...
	{
		return CONSOLESUPPORT_NAME_MAC;
	}
...
protected:
	...
	/** Helper object that tracks network connections to all Macs */
	FMacNetworkManager NetworkManager;
