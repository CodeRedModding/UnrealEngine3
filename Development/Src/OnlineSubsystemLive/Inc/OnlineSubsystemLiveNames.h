...
#if !defined(__ONLINESUBSYSTEMLIVE_NAMES_H__) || defined(NAMES_ONLY)

#ifndef __ONLINESUBSYSTEMLIVE_NAMES_H__
#define __ONLINESUBSYSTEMLIVE_NAMES_H__
#endif
...
AUTOGENERATE_NAME(OnPartyMemberListChanged)
AUTOGENERATE_NAME(OnPartyMembersInfoChanged)
AUTOGENERATE_NAME(OnPlayerTalkingStateChange)
AUTOGENERATE_NAME(OnPostImageCompleted)
AUTOGENERATE_NAME(OnPostLinkCompleted)
...
AUTOGENERATE_NAME(OnQuerySocialPostPrivilegesCompleted)
AUTOGENERATE_NAME(OnReadAchievementsComplete)
AUTOGENERATE_NAME(OnReadContentComplete)
AUTOGENERATE_NAME(OnReadCrossTitleContentComplete)
AUTOGENERATE_NAME(OnReadCrossTitleProfileSettingsComplete)
AUTOGENERATE_NAME(OnReadCrossTitleSaveGameDataComplete)
...
AUTOGENERATE_NAME(OnReadSaveGameDataComplete)
...
AUTOGENERATE_NAME(OnSendPartyGameInvitesComplete)
...
AUTOGENERATE_NAME(OnWriteSaveGameDataComplete)
