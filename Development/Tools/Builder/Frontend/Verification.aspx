<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Verification.aspx.cs" Inherits="Verification" Debug="true" %>
...
<head runat="server">
    <title>Trigger a Verification Build</title>
</head>
<body>
...
<center>
    ...
    <div>
        ...
        <br />
            ...
            <SelectParameters>
            <asp:QueryStringParameter Name="MinAccess" Type="Int32" DefaultValue="100000" />
            <asp:QueryStringParameter Name="MaxAccess" Type="Int32" DefaultValue="110000" />
            </SelectParameters>
            </asp:SqlDataSource>
...
<asp:QueryStringParameter Name="DisplayDetailID" Type="Int32" DefaultValue="100000" />
</SelectParameters>
 </asp:SqlDataSource>
