<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UE4-Builder.aspx.cs" Inherits="UE4Builder" Debug="true" %>
...
<head id="Head1" runat="server">
    <title>Trigger a UE4-Builder Build</title>
</head>
<body>
...
<center>
    ...
    <div>
        ...
        <br />
            ...
            <SelectParameters>
            <asp:QueryStringParameter Name="MinAccess" Type="Int32" DefaultValue="300000" />
            <asp:QueryStringParameter Name="MaxAccess" Type="Int32" DefaultValue="399999" />
            </SelectParameters>
            </asp:SqlDataSource>
        ...
        <ItemTemplate>
        <asp:Button ID="Button1" runat="server" Font-Bold="True" Height="26px" Text=<%# DataBinder.Eval(Container.DataItem, "[\"Description\"]") %> CommandName=<%# DataBinder.Eval(Container.DataItem, "[\"ID\"]") %> CommandArgument=<%# DataBinder.Eval(Container.DataItem, "[\"Machine\"]") %> OnPreRender="BuilderDBRepeater_OnPreRender" Width="384px" />
        <br /><br />
        </ItemTemplate>
        </asp:Repeater>
        </div>
