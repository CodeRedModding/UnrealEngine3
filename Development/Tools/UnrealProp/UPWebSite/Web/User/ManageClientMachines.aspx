<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" enableEventValidation="false" CodeFile="ManageClientMachines.aspx.cs" Inherits="Web_User_ManageClientsMachines" Title="UnrealProp - Manage Target Machines" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <ajaxToolkit:ToolkitScriptManager ID="ClientMachinesScriptManager" runat="server" />
    ...
    <table style="width: 70%; font-size: small;" >
        ...
        <tr>
            ...
            <td valign="top" align="center" style="width: 30%; height: 21px;" >
                <asp:DropDownList ID="UserTargetsUserDropDown" runat="server" Font-Size="Small" Width="85%" AutoPostBack="True" OnPreRender="TargetsUserDropDown_PreRender" />
            </td>                 
        </tr>
    </table>
    <br />
            <asp:GridView ID="UserClientMachineGridView" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" DataSourceID="UserClientMachinesDataSource" CellPadding="4" ForeColor="#333333" GridLines="None" Width="95%" PageSize="20"
                OnRowDeleting="UserClientMachineGridView_RowDeleting" OnRowUpdating="UserClientMachineGridView_RowUpdating" OnRowDataBound="UserClientMachineGridView_RowDataBound" AllowSorting="True" Font-Size="Small">
                <Columns>
    ...
    <asp:UpdatePanel ID="ClientMachineNewUpdatePanel" runat="server">
        ...
        <Triggers>
            ...
            <asp:ObjectDataSource ID="UserClientMachinesDataSource" runat="server" SelectMethod="ClientMachine_GetListForPlatformAndUser" TypeName="UnrealProp.Global" OldValuesParameterFormatString="{0}">
                <SelectParameters>
                    <asp:ControlParameter ControlID="PlatformDropDown" DefaultValue="-1" Name="PlatformID" PropertyName="SelectedValue" Type="Int16" />
                    <asp:ControlParameter ControlID="UserTargetsUserDropDown" DefaultValue="1" Name="UserNameID" PropertyName="SelectedValue" Type="Int32" />
                </SelectParameters>
