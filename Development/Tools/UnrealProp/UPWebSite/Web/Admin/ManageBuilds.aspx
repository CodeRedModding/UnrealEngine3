...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <ajaxToolkit:ToolkitScriptManager ID="BuildsAdminScriptManager" runat="server" />
    <br />
    <center>
        <table style="width: 90%; font-size: small;" >
            ...
            <tr>
                ...
                <td valign="top" align="center" style="width: 25%; height: 21px;" >
                    <asp:DropDownList ID="ManageBuildsUserDropDown" runat="server" AutoPostBack="True" Width="85%" Font-Size="Small" DataSourceID="UserDataSource" DataTextField="Description" DataValueField="ID" OnDataBound="ManageBuildsUserDropDown_DataBound" />
                </td>                
                <td valign="top" align="center" style="width: 20%; height: 21px;" >
    ...
    <asp:UpdatePanel ID="ManageBuildsUpdatePanel" runat="server" UpdateMode="Conditional">
        ...
        <center>
            <asp:GridView ID="BuildsGridView" runat="server" DataSourceID="BuildDataSource" AutoGenerateColumns="false" CellPadding="4" DataKeyNames="ID" ForeColor="#333333" Width="95%" PageSize="20"
                GridLines="None" AllowPaging="True" AllowSorting="True" Font-Size="Small" OnRowDeleting="BuildsGridView_RowDeleting" OnRowUpdating="BuildsGridView_RowUpdating" OnRowDataBound="BuildsGridView_RowDataBound">
