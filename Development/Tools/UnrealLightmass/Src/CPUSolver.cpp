...
void ReportLogFile()
{
	...
	HANDLE File = CreateFileW(*LogFilename, GENERIC_READ, FILE_SHARE_WRITE, NULL, OPEN_EXISTING, FILE_ATTRIBUTE_NORMAL, NULL);
	BOOL bIsOk = FALSE;
 ...
 */
void BuildStaticLighting(const FGuid& SceneGuid, INT NumThreads, UBOOL bDumpTextures)
{
