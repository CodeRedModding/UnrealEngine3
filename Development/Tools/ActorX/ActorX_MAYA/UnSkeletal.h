...
// @todo: We shouldn't be disabling these warnings as they help catch 64-bit problems
//   However, this Maya exporter was originally written with MANY abusive pointer/int casts that
//   seem to be safe in the context they're used in. (Swappable index storage)
