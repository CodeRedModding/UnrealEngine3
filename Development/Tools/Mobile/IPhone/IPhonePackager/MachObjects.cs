...
namespace MachObjectHandling
{
    ...
    public class MachObjectFile
    {
        ...
        // Values for CpuType
        public const UInt32 CPU_TYPE_I386 = 7;
        public const UInt32 CPU_TYPE_ARM = 12;
        public const UInt32 CPU_TYPE_POWERPC = 18;
        ...
        protected void Read(ReadingContext SR)
        {
            ...
            Flags = SR.ReadUInt32();
            SR.VerifyStreamPosition(ref ExpectedStreamPosition, 7 * sizeof(UInt32));
