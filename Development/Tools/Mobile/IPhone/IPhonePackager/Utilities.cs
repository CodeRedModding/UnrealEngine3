...
namespace iPhonePackager
{
    public class Utilities
    {
        ...
        static public string GetPrecompileSourcePListFilename()
        {
            ...
            string SourceName = FileOperations.FindPrefixedFile(Config.BuildDirectory, "IPhone-Info.plist");

            if (!File.Exists(SourceName))
            {
                // Try looking for the generic one
                SourceName = FileOperations.FindPrefixedFile(@"..\..\Development\Src\IPhone\Resources\", "IPhone-Info.plist");
            }
