...
package scaleform.clik.managers {
    ...
    // Protected Properties:
        ...
        protected var actualFocusLookup:WeakRefDictionary;// NFM: This commonly will point to an InteractiveObject while stage.focus == null.
    ...
    // Initialization:
        public function FocusHandler() {
            currentFocusLookup = new WeakRefDictionary();
            actualFocusLookup = new WeakRefDictionary();
        }
    ...
    // Public Methods:
        public function getFocus(index:uint):DisplayObject { return currentFocusLookup.getValue( index ) as DisplayObject; }
        public function setFocus(focus:DisplayObject, focusGroupIdx:uint = 0, mouseChange:Boolean = false):void {
            ...
            // Make focus change
            var actualFocus:DisplayObject = actualFocusLookup.getValue( focusGroupIdx ) as DisplayObject;
            var currentFocus:DisplayObject = currentFocusLookup.getValue( focusGroupIdx ) as DisplayObject;  //LM: DisplayObjects? Maybe UIComponents....
            ...
            if (currentFocus != focus) {
                ...
                // Turn on new focus.
                currentFocus = focus;
                currentFocusLookup.setValue( focusGroupIdx, focus );
                focusComponent = currentFocus as UIComponent;
                if (focusComponent != null) {
                    focusComponent.focused = focusComponent.focused | (1 << focusGroupIdx);
                }
            ...
            if (actualFocus != currentFocus && (!isActualFocusTextField || (isActualFocusTextField && !isCurrentFocusUIComponent))) {
                ...
                if (Extensions.isScaleform) { 
                    ...
                    var numControllers = Extensions.numControllers;
    ...
    // Protected Methods:
        protected function handleInput(event:InputEvent):void {
            ...
            var component:InteractiveObject = currentFocusLookup.getValue( focusGroupIdx ) as InteractiveObject;
            ...
            var focusedElement:InteractiveObject = currentFocusLookup.getValue( focusGroupIdx ) as InteractiveObject;
            // Get what we THINK is the stage-focused element
            var actualFocus:InteractiveObject = actualFocusLookup.getValue( focusGroupIdx ) as InteractiveObject;
        ...
        protected function handleFocusChange(oldFocus:InteractiveObject, newFocus:InteractiveObject, event:FocusEvent):void {
            ...
            */
            ...
            // Storing stage focus
            actualFocusLookup.setValue( focusGroupIdx, newFocus );
        ...
        protected function updateActualFocus(event:FocusEvent):void {
            ...
            // targets.
            var currentFocus:InteractiveObject = currentFocusLookup.getValue( focusGroupIdx ) as InteractiveObject;
        ...
        protected function handleTextFieldInput(nav:String, controllerIdx:uint):Boolean {
            var actualFocus:TextField = actualFocusLookup.getValue( controllerIdx ) as TextField;
